...
import { EleicaoComponent } from 'app/entities/eleicao/eleicao.component';
import { EleicaoService } from 'app/entities/eleicao/eleicao.service';
import { Eleicao } from 'app/shared/model/eleicao.model';

describe('Component Tests', () => {
    describe('Eleicao Management Component', () => {
        let comp: EleicaoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EleicaoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.eleicaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
